function [kdata_Under2,Traj_Under2,DensityComp_Under2,p2]=DataSorting_Resp_Cell_Label(kdata,Traj,DensityComp,Res_Signal,Res_Signal_P, cycleLabels, label, nline,para, nResp, nCard);
